/// <copyright file="BinaryReference.cs" company="Expedia">
///      Copyright (c) 2013. Expedia. All rights reserved.
/// </copyright>
/// <summary>
///      The file contains the BinaryReference class. 
/// </summary>
/// <remarks>
...
namespace com.expedia.tesla.compiler.test.passcompile.full.referencetest 
{
    ...
    /// <summary>
    /// Implementation of the BinaryReference class
    /// </summary>
    [Serializable]
    public class BinaryReference :  ISerializable
    {
        /// <summary>
        /// Class Name.
        /// </summary>
        private const string ClassName = "BinaryReference";

        /// <summary>
        /// Initializes a new instance of the <see cref="BinaryReference"/> class.
        /// </summary>
        ...
        public BinaryReference(ITeslaReader reader)
        {
        ...
        /// </summary>
        public byte[] ReferenceField1 { get; set; }
        
        /// <summary>
        /// Gets or sets the ReferenceField2 field.
        /// </summary>
        public byte[] ReferenceField2 { get; set; }
        ...
        {
            writer.WriteObjectBegin("BinaryReference");
            ...
            writer.WriteObjectEnd("BinaryReference");
        }
        ...
        {
            reader.ReadObjectBegin("BinaryReference");
            ...
            {
                this.ReferenceField1 =  reader.ReadObject<byte[]>("ReferenceField1");
                this.ReferenceField2 =  reader.ReadObject<byte[]>("ReferenceField2");
            }
            else
            {
                throw new TeslaDeserializationException("Unsupported schema version " + reader.getSchemaHash());
            }
            reader.ReadObjectEnd("BinaryReference");
        }
    }
}
